...
\NormalTok{svc }\OtherTok{\textless{}{-}} \FunctionTok{svm}\NormalTok{(y }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }\AttributeTok{data =}\NormalTok{ trainDat, }
                 \AttributeTok{kernel =} \StringTok{"linear"}\NormalTok{,}
            \AttributeTok{probability =} \ConstantTok{TRUE}\NormalTok{,}
           \AttributeTok{cost =} \FloatTok{0.01}\NormalTok{,}
           \CommentTok{\# Try "radial" if nonlinear}
                 \AttributeTok{scale =} \ConstantTok{TRUE}\NormalTok{)}


\NormalTok{ypred }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(svc, testDat)}
\FunctionTok{table}\NormalTok{(}\AttributeTok{predict =}\NormalTok{ ypred, }\AttributeTok{truth =}\NormalTok{ testDat}\SpecialCharTok{$}\NormalTok{y)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{y)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# summary(tune.out\_radial$best.model)}


\NormalTok{svm\_radial }\OtherTok{\textless{}{-}} \FunctionTok{svm}\NormalTok{(y }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }\AttributeTok{data =}\NormalTok{ trainDat, }
...
\NormalTok{ypred\_radial }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(svm\_radial, testDat)}
\FunctionTok{table}\NormalTok{(}\AttributeTok{predict =}\NormalTok{ ypred\_radial, }\AttributeTok{truth =}\NormalTok{ testDat}\SpecialCharTok{$}\NormalTok{y)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{plot}\NormalTok{(cv.data}\SpecialCharTok{$}\NormalTok{size, cv.data}\SpecialCharTok{$}\NormalTok{dev, }\AttributeTok{type =} \StringTok{"b"}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(cv.data}\SpecialCharTok{$}\NormalTok{k, cv.data}\SpecialCharTok{$}\NormalTok{dev, }\AttributeTok{type =} \StringTok{"b"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{3_1_modeling_files/figure-latex/unnamed-chunk-10-1.pdf}}
...
\NormalTok{prune.data }\OtherTok{\textless{}{-}} \FunctionTok{prune.misclass}\NormalTok{(tree.data, }\AttributeTok{best =} \DecValTok{8}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(prune.data)}
\FunctionTok{text}\NormalTok{(prune.data, }\AttributeTok{pretty =} \DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{3_1_modeling_files/figure-latex/unnamed-chunk-11-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}

\NormalTok{tree.pred }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(prune.data, testDat, }\AttributeTok{type =} \StringTok{"class"}\NormalTok{)}
\FunctionTok{table}\NormalTok{(tree.pred, y[}\SpecialCharTok{{-}}\NormalTok{train])}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{3_1_modeling_files/figure-latex/unnamed-chunk-15-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Extract importance}
\NormalTok{var\_imp }\OtherTok{\textless{}{-}} \FunctionTok{importance}\NormalTok{(rf.data)}
...
\CommentTok{\# Sort and select top 8}
\NormalTok{accuracy }\OtherTok{\textless{}{-}}\NormalTok{ var\_imp\_df[}\FunctionTok{order}\NormalTok{(var\_imp\_df}\SpecialCharTok{$}\NormalTok{MeanDecreaseAccuracy, }\AttributeTok{decreasing =} \ConstantTok{TRUE}\NormalTok{), ][}\DecValTok{1}\SpecialCharTok{:}\DecValTok{10}\NormalTok{, ]}
\NormalTok{gini }\OtherTok{\textless{}{-}}\NormalTok{ var\_imp\_df[}\FunctionTok{order}\NormalTok{(var\_imp\_df}\SpecialCharTok{$}\NormalTok{MeanDecreaseGini, }\AttributeTok{decreasing =} \ConstantTok{TRUE}\NormalTok{), ][}\DecValTok{1}\SpecialCharTok{:}\DecValTok{10}\NormalTok{, ]}

\NormalTok{varNameAcc }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"\% White"}\NormalTok{, }\StringTok{"\% Black"}\NormalTok{, }\StringTok{"Masters Degree \%"}\NormalTok{, }\StringTok{"Professional Degree \%"}\NormalTok{, }\StringTok{"Max COVID{-}19 Weekly Death Rate"}\NormalTok{, }\StringTok{"Population"}\NormalTok{, }\StringTok{"PhD \%"}\NormalTok{, }\StringTok{"\% Asian"}\NormalTok{, }\StringTok{"COVID{-}19 Death Rate"}\NormalTok{, }\StringTok{"High School Diploma \%"}\NormalTok{)}


\NormalTok{varNameGini }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"\% White"}\NormalTok{, }\StringTok{"Masters Degree \%"}\NormalTok{,}\StringTok{"\% Black"}\NormalTok{,   }\StringTok{"Professional Degree \%"}\NormalTok{,  }\StringTok{"Max COVID{-}19 Weekly Death Rate"}\NormalTok{,}\StringTok{"PhD \%"}\NormalTok{,}\StringTok{"\% Asian"}\NormalTok{, }\StringTok{"High School Diploma \%"}\NormalTok{, }\StringTok{"Population"}\NormalTok{, }\StringTok{"Bachelors Degree \%"}\NormalTok{)}

\CommentTok{\# Plot with ggplot2}
\NormalTok{accPlot }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(accuracy, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \FunctionTok{reorder}\NormalTok{(varNameAcc, MeanDecreaseAccuracy), }\AttributeTok{y =}\NormalTok{ MeanDecreaseAccuracy)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\CommentTok{\#title = "Top 8 Variable Importances",}
       \AttributeTok{x =} \StringTok{""}\NormalTok{,}
       \AttributeTok{y =} \StringTok{"Mean Decrease Accuracy"}\NormalTok{) }\CommentTok{\#+}
  \CommentTok{\#theme\_minimal()}

\NormalTok{giniPlot }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(gini, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \FunctionTok{reorder}\NormalTok{(varNameGini, MeanDecreaseGini), }\AttributeTok{y =}\NormalTok{ MeanDecreaseGini)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{col =} \StringTok{"steelblue"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{coord\_flip}\NormalTok{() }\SpecialCharTok{+}  \CommentTok{\# Horizontal bars}
  \FunctionTok{labs}\NormalTok{(}\CommentTok{\#title = "Top 8 Variable Importances",}
       \AttributeTok{x =} \StringTok{""}\NormalTok{,}
       \AttributeTok{y =} \StringTok{"Mean Decrease GINI"}\NormalTok{)}


\NormalTok{gridExtra}\SpecialCharTok{::}\FunctionTok{grid.arrange}\NormalTok{(accPlot, giniPlot, }\AttributeTok{ncol=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{3_1_modeling_files/figure-latex/unnamed-chunk-16-1.pdf}}
\#\# Boosted Trees
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{trainDatBoost }\OtherTok{\textless{}{-}}\NormalTok{ trainDat }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{y =} \FunctionTok{as.numeric}\NormalTok{(y)}\SpecialCharTok{{-}}\DecValTok{1}
\NormalTok{  )}

\NormalTok{testDatBoost }\OtherTok{\textless{}{-}}\NormalTok{ testDat }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{y =} \FunctionTok{as.numeric}\NormalTok{(y)}\SpecialCharTok{{-}}\DecValTok{1}
\NormalTok{  )}


\NormalTok{boost.data }\OtherTok{\textless{}{-}} \FunctionTok{gbm}\NormalTok{(y }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }\AttributeTok{data =}\NormalTok{ trainDatBoost, }\AttributeTok{distribution =} \StringTok{"bernoulli"}\NormalTok{, }
                  \AttributeTok{n.trees =} \DecValTok{5000}\NormalTok{, }\AttributeTok{interaction.depth =} \DecValTok{4}\NormalTok{)}
                  
\FunctionTok{summary}\NormalTok{(boost.data)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{3_1_modeling_files/figure-latex/unnamed-chunk-17-1.pdf}}
...
## x.positive_consumer_spending                                3.155271e-02
## x.estimate_total_male_55_to_59_years                        2.766321e-02
## x.estimate_households_total_less_than_10_000                2.595130e-02
## x.positive_employment                                       2.576297e-02
## x.estimate_total_male_35_to_39_years                        1.656953e-02
## x.negative_consumer_spending                                1.287711e-02
## x.estimate_total_6th_grade                                  7.184594e-03
## x.final_consumer_spending                                   3.991106e-03
## x.positive_sb_open                                          5.305553e-04
## x.estimate_total_2nd_grade                                  5.199098e-04
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 1. Get relative influence WITHOUT plotting}
\NormalTok{rel\_influence }\OtherTok{\textless{}{-}} \FunctionTok{summary}\NormalTok{(boost.data, }\AttributeTok{plotit =} \ConstantTok{FALSE}\NormalTok{)}

\CommentTok{\# 2. Take top 10 variables}
\NormalTok{top10 }\OtherTok{\textless{}{-}}\NormalTok{ rel\_influence[}\FunctionTok{order}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{rel\_influence}\SpecialCharTok{$}\NormalTok{rel.inf), ][}\DecValTok{1}\SpecialCharTok{:}\DecValTok{10}\NormalTok{, ]}

\NormalTok{boostVarNames }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"\% White"}\NormalTok{, }\StringTok{"Masters Degree \%"}\NormalTok{, }\StringTok{"Professional Degree \%"}\NormalTok{, }
                   \StringTok{"Max COVID{-}19 Weekly Death Rate"}\NormalTok{, }\StringTok{"COVID{-}19 Death Rate"}\NormalTok{,}\StringTok{"\% Black"}\NormalTok{,}\StringTok{"Population"}\NormalTok{, }\StringTok{"\% Asian"}\NormalTok{,    }\StringTok{"Some College Less than 1 year"}\NormalTok{, }\StringTok{"\% American Indian/Alaska Native"}\NormalTok{)}

 

\CommentTok{\# 3. Plot with ggplot2}
\FunctionTok{ggplot}\NormalTok{(top10, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \FunctionTok{reorder}\NormalTok{(boostVarNames, rel.inf), }\AttributeTok{y =}\NormalTok{ rel.inf)) }\SpecialCharTok{+}
  \FunctionTok{geom\_col}\NormalTok{(}\AttributeTok{fill =} \StringTok{"steelblue"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{coord\_flip}\NormalTok{() }\SpecialCharTok{+}  \CommentTok{\# Horizontal bars}
  \FunctionTok{labs}\NormalTok{(}
    \CommentTok{\#title = "Top 10 Variable Influences",}
    \AttributeTok{x =} \StringTok{" "}\NormalTok{,}
    \AttributeTok{y =} \StringTok{"Relative Influence (\%)"}
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{(}\AttributeTok{base\_size =} \DecValTok{14}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{3_1_modeling_files/figure-latex/unnamed-chunk-18-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(boost.data, }\AttributeTok{i =} \StringTok{"x.one\_race\_white\_alone"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{3_1_modeling_files/figure-latex/unnamed-chunk-19-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(boost.data, }\AttributeTok{i =} \StringTok{"x.estimate\_total\_masters\_degree"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{3_1_modeling_files/figure-latex/unnamed-chunk-19-2.pdf}}
...
\NormalTok{yhat.boost }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(boost.data, }\AttributeTok{newdata =}\NormalTok{ testDatBoost, }\AttributeTok{n.trees =} \DecValTok{5000}\NormalTok{, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{)}
\NormalTok{rf.pred }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(rf.data, }\AttributeTok{newdata =}\NormalTok{ testDat, }\AttributeTok{type =} \StringTok{"class"}\NormalTok{)}

\NormalTok{boost.pred }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(yhat.boost }\SpecialCharTok{\textgreater{}} \FloatTok{0.5}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)}

\FunctionTok{table}\NormalTok{(boost.pred, y[}\SpecialCharTok{{-}}\NormalTok{train])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{X\_lasso }\OtherTok{\textless{}{-}} \FunctionTok{as.matrix}\NormalTok{(trainDat[, }\FunctionTok{colnames}\NormalTok{(trainDat) }\SpecialCharTok{!=} \StringTok{"y"}\NormalTok{])}
\NormalTok{y\_lasso }\OtherTok{\textless{}{-}}\NormalTok{ trainDat}\SpecialCharTok{$}\NormalTok{y}

\CommentTok{\# Step 2: Fit Lasso logistic regression with cross{-}validation}
\NormalTok{lasso\_fit }\OtherTok{\textless{}{-}} \FunctionTok{cv.glmnet}\NormalTok{(}
\NormalTok{  X\_lasso, y\_lasso, }
  \AttributeTok{family =} \StringTok{"binomial"}\NormalTok{,}
  \AttributeTok{alpha =} \DecValTok{1}\NormalTok{,       }\CommentTok{\# Lasso penalty}
  \AttributeTok{nfolds =} \DecValTok{5}
\NormalTok{)}

\CommentTok{\# Step 3: Find best lambda}
\NormalTok{best\_lambda }\OtherTok{\textless{}{-}}\NormalTok{ lasso\_fit}\SpecialCharTok{$}\NormalTok{lambda.min}

\CommentTok{\# Step 4: Extract selected variables}
\NormalTok{lasso\_coefs }\OtherTok{\textless{}{-}} \FunctionTok{coef}\NormalTok{(lasso\_fit, }\AttributeTok{s =}\NormalTok{ best\_lambda)}
\NormalTok{selected\_vars }\OtherTok{\textless{}{-}} \FunctionTok{rownames}\NormalTok{(lasso\_coefs)[lasso\_coefs[,}\DecValTok{1}\NormalTok{] }\SpecialCharTok{!=} \DecValTok{0}\NormalTok{]}
\NormalTok{selected\_vars }\OtherTok{\textless{}{-}} \FunctionTok{setdiff}\NormalTok{(selected\_vars, }\StringTok{"(Intercept)"}\NormalTok{)}

\CommentTok{\# Step 5: Build logistic regression on selected variables}
\CommentTok{\# Subset the original data to selected variables}
\NormalTok{X\_selected }\OtherTok{\textless{}{-}}\NormalTok{ trainDat[, selected\_vars, drop }\OtherTok{=} \ConstantTok{FALSE}\NormalTok{]}

\CommentTok{\# Build final logistic regression}
\NormalTok{final\_logit\_model }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(}
\NormalTok{  y }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }
  \AttributeTok{data =} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{y =}\NormalTok{ y\_lasso, X\_selected), }
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# \# Define function to calculate evaluation metrics}
\CommentTok{\# evaluate\_model \textless{}{-} function(pred\_class, actual\_class, pred\_probs) \{}
\CommentTok{\#   conf\_matrix \textless{}{-} confusionMatrix(pred\_class, actual\_class, positive = "1")}
\CommentTok{\#   }
\CommentTok{\#   precision \textless{}{-} conf\_matrix$byClass["Pos Pred Value"]}
\CommentTok{\#   recall \textless{}{-} conf\_matrix$byClass["Sensitivity"]}
\CommentTok{\#   f1 \textless{}{-} 2 * (precision * recall) / (precision + recall)}
\CommentTok{\#   }
\CommentTok{\#   roc\_obj \textless{}{-} roc(actual\_class, pred\_probs)}
\CommentTok{\#   auc\_value \textless{}{-} auc(roc\_obj)}
\CommentTok{\#   }
\CommentTok{\#   metrics \textless{}{-} list(}
\CommentTok{\#     Accuracy = conf\_matrix$overall["Accuracy"],}
\CommentTok{\#     Precision = precision,}
\CommentTok{\#     Recall = recall,}
\CommentTok{\#     F1\_Score = f1,}
\CommentTok{\#     AUC = auc\_value}
\CommentTok{\#   )}
\CommentTok{\#   }
...
\NormalTok{evaluate\_model }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(pred\_class, actual\_class, pred\_probs) \{}
\NormalTok{  conf\_matrix }\OtherTok{\textless{}{-}} \FunctionTok{confusionMatrix}\NormalTok{(pred\_class, actual\_class, }\AttributeTok{positive =} \StringTok{"1"}\NormalTok{)}
  
\NormalTok{  precision }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(conf\_matrix}\SpecialCharTok{$}\NormalTok{byClass[}\StringTok{"Pos Pred Value"}\NormalTok{])}
\NormalTok{  recall    }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(conf\_matrix}\SpecialCharTok{$}\NormalTok{byClass[}\StringTok{"Sensitivity"}\NormalTok{])}
...
\NormalTok{  roc\_obj   }\OtherTok{\textless{}{-}} \FunctionTok{roc}\NormalTok{(actual\_class, pred\_probs)}
\NormalTok{  auc\_value }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(}\FunctionTok{auc}\NormalTok{(roc\_obj))}
  
\NormalTok{  metrics }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}
    \AttributeTok{Accuracy  =} \FunctionTok{as.numeric}\NormalTok{(conf\_matrix}\SpecialCharTok{$}\NormalTok{overall[}\StringTok{"Accuracy"}\NormalTok{]),}
    \AttributeTok{Precision =}\NormalTok{ precision,}
    \AttributeTok{Recall    =}\NormalTok{ recall,}
    \AttributeTok{F1\_Score  =}\NormalTok{ f1,}
    \AttributeTok{AUC       =}\NormalTok{ auc\_value}
\NormalTok{  )}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Combine and label with AUC}
\NormalTok{roc\_list }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}
  \StringTok{"Boosted Tree"}  \OtherTok{=}\NormalTok{ roc\_boost,}
  \StringTok{"Random Forest"} \OtherTok{=}\NormalTok{ roc\_rf,}
  \StringTok{"Decision Tree"} \OtherTok{=}\NormalTok{ roc\_tree,}
  \StringTok{"Logistic Regression"} \OtherTok{=}\NormalTok{ roc\_lasso,}
  \StringTok{"SVC"} \OtherTok{=}\NormalTok{ roc\_svc,}
  \StringTok{"SVM"} \OtherTok{=}\NormalTok{ roc\_svm}
\NormalTok{)}

\CommentTok{\# Rename with AUC values included}
\NormalTok{roc\_list\_named }\OtherTok{\textless{}{-}} \FunctionTok{setNames}\NormalTok{(}
\NormalTok{  roc\_list,}
  \FunctionTok{sapply}\NormalTok{(}\FunctionTok{names}\NormalTok{(roc\_list), }\ControlFlowTok{function}\NormalTok{(name) \{}
\NormalTok{    auc\_value }\OtherTok{\textless{}{-}} \FunctionTok{auc}\NormalTok{(roc\_list[[name]])}
    \FunctionTok{sprintf}\NormalTok{(}\StringTok{"\%s (AUC = \%.2f)"}\NormalTok{, name, auc\_value)}
\NormalTok{  \})}
\NormalTok{)}
...
\CommentTok{\# Create the ROC plot}
\FunctionTok{ggroc}\NormalTok{(roc\_list\_named, }\AttributeTok{aes =} \FunctionTok{c}\NormalTok{(}\StringTok{"color"}\NormalTok{), }\AttributeTok{linewidth =} \FloatTok{1.2}\NormalTok{, }\AttributeTok{legacy.axes =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}
    ...
    \AttributeTok{title =} \StringTok{"ROC Curve Comparison"}\NormalTok{,}
    \AttributeTok{color =} \StringTok{"Model"}
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{scale\_color\_brewer}\NormalTok{(}\AttributeTok{palette =} \StringTok{"Set1"}\NormalTok{, }\AttributeTok{direction =} \SpecialCharTok{{-}}\DecValTok{1}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_abline}\NormalTok{(}\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{, }\AttributeTok{color =} \StringTok{"grey50"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{3_1_modeling_files/figure-latex/unnamed-chunk-27-1.pdf}}
